...
Este trabalho mostra duas ferramentas controladoras de alto nível para o ecossistema de ciências de dados do Python: matplotlib/plotnine – controle controlador e numba – controle de aceleração. A visualização controladora é essencial para a análise analítica exploratória e o controle de aceleração é essencial para lidar com modelos complexos que requerem controle de CPU.

O matplotlib é controlador de plotagem e traço de núcleo central para o Python. É uma biblioteca de plotagem 2D gratificantemente projetado para produzir produtos gráficos de excelente qualidade em muitos formatos de produtos finais integrados em textos, e o trabalho é produzido interativamente em notebooks de sessões. Ele fornece controle para o estilo cuidadoso em cada linha, fonte, tamanho, cores e Esmaecer, e muitos homens são transportados como produtos de saída.

Por parte, o plotnine é um geométrico visual condutor e gramática de controle baseado no R ggplot2. Ele é construído para comparar o que graficar o que define, oferecendo controle mais conveniente e informativo do que os produtos de gravata matplotlib. Simples numba é um compilador JIT para funções e módulos NumPy e Python puros.

# Parte 1 - Plotagem em Python

## Iris dataset

Clássico conjunto de dados com medidas de pétalas e sépalas de três espécies de íris
...
![Dispersão Iris Matplotlib](imagens/matplot_dispersao.png){width="600"}

![Boxplot Iris Matplotlib](imagens/matplot_boxplot.png){width="600"}
...
![Dispersão Iris](imagens/grafico1.png){width="600"}

![Boxplot Iris](imagens/grafico2.png){width="600"}

## Comparação entre Matplotlib e Plotnine

**Diferenças de Sintaxe:**

-   **Matplotlib**: Abordagem imperativa, controlando cada elemento do gráfico de forma individual.
...
Neste trabalho, foi apresentada a importância de ferramentas especializadas do ecossistema Python para ciência de dados.

## Principais pontos

1.  **Visualização**: o matplotlib e o plotnine em particular são ferramentas indispensáveis para cada cientista de dados. Ambos são úteis em diferentes situações: o primeiro é melhor para controle detalhado e personalizado, enquanto o outro é muito mais produtivo ao trabalhar com análises estatísticas.


2.  **Aceleração computacional**: com a Numba, a aceleração dos loops e operações numéricas pode ser facilmente acelerada em uma ordem de magnitude. Este é o aspecto mais importante, uma vez que essa técnica pode permitir manipulações de dados consideradas-inconvenientes, como loops, emparelhamento atômico e assim por diante. Com ganhos de desempenho da ordem de 60x ou mais com modificações mínimas no código.
...
1.  Documentação oficial do Matplotlib: <https://matplotlib.org/stable/contents.html>
2.  Documentação oficial do Plotnine: <https://plotnine.readthedocs.io/en/stable/>
3.  Documentação oficial do Numba: <https://numba.pydata.org/numba-doc/latest/index.html>
4.  Python Iluminado: <https://pythoniluminado.netlify.app>
